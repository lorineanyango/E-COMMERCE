...
import { FaClock, FaBox, FaShoppingCart, FaStar, FaStore } from "react-icons/fa"
  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <>
          <div className="flex flex-wrap relative item-between mt-[2rem] ml-[10rem]">
            <div>
              <img 
              src={product.image} 
              alt={product.name} 
              className="w-full xl:w-[50rem] 
              lg:w-[45rem] md:w-[30rem] 
              sm:w-[20rem] mr-[2rem]" />
            ...
            <div className="flex flex-col justify-between">
              ...
              <div className="btn-container">
                ...
                className="bg-blue-600 text-white py-2 rounded-lg mt-4 md:mt-0">
                  Add to Cart
                </button>
              </div>
            </div>
