  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <section className="mr-[5rem]">
        ...
        onClick={()=> handleTabClick(2)}>All Review
        </div>
            ...
            {userInfo ? (
              <form onSubmit={submitHandler}>
                <div className="my-2">
                  ...
                  onChange={e=> setRating(e.target.value)} className="p-2 border rounded-lg xl:w-[40rem] text-block">
                ...
                className="bg-blue-600 text-white py-2 rounded-lg" >Submit</button>
              </form>
            ) : (
        ...
        {activeTab === 2 && (
          ...
          <div>
            {product.reviews.map((review)=>(
              <div key={review._id} className="bg-[#1A1A1A] p-4 
              rounded-lg xl:ml-[2rem] sm:ml-[0rem] 
              xl:w-[50rem] s,:w-[20rem] mb-5
              ">
